---
title: C++ const 关键字详解：修饰变量、指针和函数
shortTitle: C++ const 关键字
description: 本文详细介绍了C++中const关键字的用法，包括修饰变量、指针、函数等场景，以及const_cast的注意事项和编译器优化相关知识。
head:
  - - meta
    - name: keywords
      content: C++, const, const指针, const函数, const_cast, 常量, 只读变量
---
